    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animatorTranslateX = ObjectAnimator.ofFloat(view, "translationX", -200, 200);
                ObjectAnimator animatorRotation = ObjectAnimator.ofFloat(view, "rotation", 0, 1080);
                ...
                animatorSet.playSequentially(animatorAlpha,animatorTranslateX,animatorRotation);
